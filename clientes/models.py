...
class Cliente(models.Model):
    ...
    rgie = models.CharField(max_length=14, blank=True,
                            null=True, verbose_name="Insc.Estadual")
    ...
    uf = models.CharField(max_length=2, default='MG',
                          choices=UF_CHOICES, verbose_name="UF")
    email = models.EmailField(blank=True, verbose_name="E-mail")
    phone1 = models.CharField(max_length=15, verbose_name="Telefone")
    phone2 = models.CharField(
        max_length=15, blank=True, verbose_name="Telefone")
