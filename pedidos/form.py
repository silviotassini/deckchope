...
class FormPedido(forms.ModelForm):                    
    ...
    def __init__(self, flag=False, *args, **kwargs):
        ...
        if flag: # In update view cliente is disable
            self.fields['cliente'].disabled = True

        self.helper.layout = Layout(
            'usuario',
            Field('cliente', style='width:60%;max-width: 35em;'),         
            Row(
                Column( Field('data_pedido', style='max-width: 15em'), css_class='form-group col-md-3 mb-0'),
                Column( Field('data_entrega'), css_class='form-group col-md-3 mb-0'),
    ...
    class Meta:
        model = Pedido
        fields=('usuario','cliente','data_pedido','data_entrega','data_pgto','forma_pgto','obs')
...
class FormPedidoEntregar(forms.ModelForm):      
    ...
    def __init__(self, flag=False, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                Column( Field('data_entrega'), css_class='form-group col-md-6 mb-0'),
                css_class='form-row',
            ),            
            'obs',
        ) 
...
class FormPedidoPagar(forms.ModelForm):  
    ...
    def __init__(self, flag=False, *args, **kwargs):        
        ...
        self.helper.layout = Layout(
            Row(
                Column( Field('forma_pgto'), css_class='form-group col-md-6 mb-0'),
                Column( Field('data_pgto', css_class="vDateField"), css_class='form-group col-md-6 mb-0'),                
                css_class='form-row',
            ),            
            'obs',
        )
...
ItemPedidoFormSet = forms.inlineformset_factory(Pedido, ItemPedido, extra=1, can_delete=True, form=FormItemPedido)            